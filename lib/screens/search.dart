                          ...
                          children: [
                            Column( 
                              ...
                              children: [
                                ...
                                MyText.baseText(text: 'Thái Nguyên, Việt nam',color: colorWhiteOpacity, size: 16),
                                MyText.baseText(text: DateFormat.MMMEd('vi').add_jm().format(DateTime.now()),color: colorWhiteOpacity, size: 16),
                            ...
                            Column(
                              children: [
                                Row(
                                 ...
                                 Row(
                                   children: [
                                    MyText.temp(temp: 22 , size: 16,color: colorWhiteOpacity,),
                                    MyText.baseText(text: '/ ', color: colorWhiteOpacity, size: 16),
                                    MyText.temp(temp: 25 , size: 16, color: colorWhiteOpacity,) ,
                                   ],
                                 ) ,
